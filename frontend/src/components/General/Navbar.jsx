...
const navigation = [
    ...
    { name: 'Shirts', href: '#', current: false },
    { name: 'Jeans', href: '#', current: false },
    { name: 'T-shirt', href: '#', current: false },
    ...
    return (
        <nav className="flex items-center justify-between  py-2 lg:py-3  bg-black text-white sticky top-0 z-10">
            ...
            <ul className="hidden md:flex md:gap-10 font-oswald text-lg">
                {
                    navigation.map((link, index) =>
                        <li key={index}>
                            <a href={link.href} className="text-white hover:text-gray-400">{link.name}</a>
                        </li>
                    )
                }
            ...
            <ul className="hidden md:flex md:gap-10 text-lg">
                ...
                {/* <li>
                    <a href="/about" className="text-white hover:text-gray-400">Accessories</a>
                </li> */}
                <li className='mt-5'>
                    <a href="/faq" className="text-white hover:text-gray-400 flex relative">
                ...
                <li>
                    {/* <a href="/about" className="text-white hover:text-gray-400">Contact Us</a> */}
                    <Search/>
                </li>
            </ul>
